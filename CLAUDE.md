...
This project is indexed by GitNexus as **kpi_source_code_v4** (5502 symbols, 17931 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
