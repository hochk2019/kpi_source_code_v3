...
function loadFromSecureFile(options = {}) {
  ...
  if (os.platform() !== "win32") {
    console.warn(
      "ECUS_SQL_SECURE_FILE chi co the giai ma tren Windows. Vui long chay tren moi truong Windows 11 Pro.",
    );
    return null;
  }
  ...
  try {
    ...
    console.error("Khong the giai ma thong tin dang nhap ECUS tu DPAPI.", error);
    return null;
  }
}
