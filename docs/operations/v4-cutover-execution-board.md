...
| CUT-05 | cng-m2r.6 | sam | CUT-04 | In Progress | `pnpm run verify:v4:cutover-preflight -- --with-uat-smoke --timeout-ms 120000` | docs/operations/v4-cutover-evidence/2026-04-01T15-21-50-197Z-manual-cutover-preflight.md | UAT smoke dang fail (account/team/report viewer Playwright), tiep tuc hypercare lane. |
