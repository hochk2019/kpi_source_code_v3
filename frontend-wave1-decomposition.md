...
- Post-wave-1 backlog khong con duoc track tiep trong file nay; toan bo viec con mo sau wave 1 hien nam tai `docs/open-backlog.md`, dac biet cac bead structural con mo `cng-2k4.16` va `cng-2k4.17`.
