...
export default function App() {
  ...
  return (
    <div
      ref={rootRef}
      className="min-h-screen bg-gray-50 text-gray-900 transition-colors duration-300"
    >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-gray-800 dark:text-gray-100">
              ...
              <h1 className="text-xl font-semibold leading-tight">
                Hệ thống KPI nhân viên khai báo hải quan
              </h1>

              <p className="text-sm text-gray-500 dark:text-gray-400">
                Công ty TNHH Tiếp Vận Hoàng Kim
              </p>
            </div>
          </div>
      ...
      {syncStatus?.waitingForBackend && isAdmin && (
        <div className="border-b border-amber-200 bg-amber-50 dark:border-amber-400/40 dark:bg-amber-500/15">
          <div className="mx-auto flex max-w-6xl flex-col gap-1 px-4 py-3 text-sm text-amber-800 dark:text-amber-200 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-xs text-amber-700 dark:text-amber-200 sm:text-sm">
              Vui lòng khởi động dịch vụ backend (pnpm server) hoặc kiểm tra kết nối LAN rồi chờ hệ
              thống tự đồng bộ.
            </div>
          </div>
        </div>
      ...
      <main className="px-4 py-6">
        <Suspense
          fallback={
            <div className="text-sm text-gray-500 dark:text-gray-400">Đang tải dashboard...</div>
          }
        >
