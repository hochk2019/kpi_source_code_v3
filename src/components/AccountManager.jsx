  ...
  return (
    <label className={baseClass} title={label}>
      ...
      <span className="flex min-w-0 flex-col">
        ...
        {!compact && description && (
          <span className="text-xs leading-4 text-[color:var(--ds-text-secondary)]">
            {description}
          </span>
        )}
      </span>
    ...
    () => [
      {
        ...
        cell: (account) => (
          <div className="font-semibold text-[color:var(--ds-text-primary)]">
            {account.username}
          </div>
        ),
      },
              ...
              {rosterMissing ? (
                ...
                inRoster ? (
                  ...
                  <StatusBadge tone="warning">
                    Nhân viên này không còn trong danh sách KPI
                  </StatusBadge>
                )
              ) : (
      ...
      return (
        <div className="space-y-1 text-sm text-[color:var(--ds-text-secondary)]">
          ...
          <p className="text-[color:var(--ds-text-muted)]">
            Sử dụng biểu mẫu phía trên để tạo tài khoản đầu tiên.
          </p>
        </div>
      );
    }
  ...
  return (
    <div className="space-y-6">
      <div className="ds-callout ds-callout--info text-sm">
        <p>
          Quản lý tài khoản đăng nhập cho hệ thống KPI, gán quyền và nhân viên phụ trách theo từng
          tổ đội.
        </p>

        <p className="text-xs text-[color:var(--ds-text-muted)]">
          Mọi thao tác đều được ghi nhận trong mục Nhật ký để dễ dàng truy vết.
        </p>
      </div>

      <section className="ds-card space-y-6">
        <header className="space-y-1">
          <h2 className="text-lg font-semibold text-[color:var(--ds-text-primary)]">
            Tạo tài khoản mới
          </h2>

          <p className="text-sm text-[color:var(--ds-text-secondary)]">
            Điền thông tin đăng nhập, gắn nhân viên KPI (nếu có) và xác định quyền tương ứng trước
            khi tạo tài khoản.
          </p>
        </header>
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={handleCreate}>
          ...
          <div className="md:col-span-2 space-y-4">
            <div>
              <div className="text-sm font-medium text-[color:var(--ds-text-primary)]">
                Quyền chức năng
              </div>

              <p className="text-xs text-[color:var(--ds-text-muted)]">
                Chọn quyền tương ứng cho tài khoản. Những quyền bị làm mờ thuộc nhóm chỉ dành cho
                quản trị viên.
              </p>
            </div>
      ...
      <section className="ds-card space-y-4">
        <header className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-[color:var(--ds-text-secondary)]">
              Theo dõi quyền truy cập và trạng thái gắn nhân viên.
            </p>
          </div>
                ...
                <div className="grid gap-2 [grid-template-columns:repeat(auto-fit,minmax(240px,1fr))]">
                  {permissionDefinitions.map((definition) => (
                    <PermissionCheckbox
                      ...
                      disabled={
                        pendingAccounts.has(permissionAccount.username) ||
                        (definition.key === "accountManage" &&
                          permissionAccount.role !== ADMIN_ROLE)
                      }
                    />
                  ))}
                </div>
            ...
            {accountToDelete && (
              <div className="space-y-1 text-sm text-[color:var(--ds-text-secondary)]">
                ...
                {accountToDelete.memberName ? (
                  ...
                  <p className="text-[color:var(--ds-text-muted)]">
                    Tài khoản chưa gắn nhân viên KPI.
                  </p>
                )}
