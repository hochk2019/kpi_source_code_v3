...
export default function CommandCenter({
  ...
  const entries = useMemo(
    () => formatResults(commands, pinned, usage, query),
    [commands, pinned, usage, query],
  );
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-slate-900/40 px-4 py-24 backdrop-blur-sm">
          <div className="w-full max-w-3xl overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl transition dark:border-slate-700 dark:bg-slate-900">
            ...
            <div className="flex items-center justify-between border-t border-gray-200 bg-gray-50 px-5 py-3 text-xs text-gray-500 dark:border-slate-700 dark:bg-slate-900/80 dark:text-gray-400">
              <span>
                Gợi ý: sử dụng{" "}
                <kbd className="rounded border border-gray-300 bg-white px-1 py-0.5 text-[10px] text-gray-600">
                  ↑↓
                </kbd>{" "}
                để di chuyển,{" "}
                <kbd className="rounded border border-gray-300 bg-white px-1 py-0.5 text-[10px] text-gray-600">
