...
function CommandCenterEmptyState({ suggestions, onRunSuggestion }: CommandCenterEmptyStateProps) {
  return (
...
export default function CommandCenter({
  ...
  const handleInlineChange = useCallback((value: string) => {
