          ...
          <div className="flex flex-wrap items-center gap-1">
            ...
            <dd className="flex flex-wrap items-center gap-1">
              ...
              {item.tags.map((tag) => (
                ...
                <span key={tag} className="rounded bg-gray-100 px-1.5 py-0.5 text-[11px] font-medium text-gray-600 dark:bg-slate-800 dark:text-gray-300">
            ...
            <Tabs.Root value={activeTab} onValueChange={setActiveTab} className="grid gap-4">
              ...
              <Tabs.Content value="training" className="grid gap-4">
                ...
                {loading ? (
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Đang tải tài liệu đào tạo...</p>
              ...
              <Tabs.Content value="feedback" className="grid gap-4">
                ...
                <form className="grid gap-4" onSubmit={handleSubmit}>
                  ...
                  <div className="grid gap-1">
                    ...
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-200" htmlFor="feedback-category">
                  ...
                  <div className="grid gap-1">
                    ...
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-200" htmlFor="feedback-message">
                  ...
                  <div className="grid gap-1 sm:grid-cols-2 sm:gap-4">
                    ...
                    <div className="grid gap-1">
                      ...
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-200" htmlFor="feedback-rating">
                    ...
                    <div className="grid gap-1">
                      ...
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-200" htmlFor="feedback-contact">
