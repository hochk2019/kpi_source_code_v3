          ...
          {isLoading ? (
            <TableRow>
              <TableCell
                ...
                className={cn("text-center text-[color:var(--ds-text-muted)]", paddingClass)}
              >
                Đang tải dữ liệu…
              </TableCell>
            </TableRow>
...
const toneClassName = {
  ...
  info: "bg-sky-100 text-sky-700 border border-sky-200 dark:bg-sky-500/20 dark:text-sky-100 dark:border-sky-500/40",
...
export function StatusBadge({ tone = "neutral", className, children, icon, ...props }) {
  ...
  return (
    ...
    >
      {icon ? (
        <span className="inline-flex h-3 w-3 items-center justify-center">{icon}</span>
      ) : null}
      ...
      <SelectContent className={cn("ds-select-content", contentClassName)}>
        {items.map((item) => (
          <SelectItem
            ...
            value={item.value ?? EMPTY_OPTION_VALUE}
            className="text-sm"
          >
            {item.label}
          </SelectItem>
...
export const AppDialogContent = React.forwardRef(function AppDialogContent(
  ...
  return (
    <BaseDialogContent ref={ref} className={cn("ds-dialog", sizeClass, className)} {...props} />
  );
});
...
export const AppDialogHeader = React.forwardRef(function AppDialogHeader(
  ...
  return <BaseDialogHeader ref={ref} className={cn("ds-dialog__header", className)} {...props} />;
});
...
export const AppDialogTitle = React.forwardRef(function AppDialogTitle(
  ...
  return <BaseDialogTitle ref={ref} className={cn("ds-dialog__title", className)} {...props} />;
});
...
export const AppDialogFooter = React.forwardRef(function AppDialogFooter(
  ...
  return <BaseDialogFooter ref={ref} className={cn("ds-dialog__footer", className)} {...props} />;
});
