...
- Highest-priority ready items hien tai:
  - `cng-ro9.8` (active wave-5 code slice: tiep tuc low-risk caller migration off `@/lib/store.js` sau khi batch normalize/helper dau tien da xanh)
